...
NSLog(@"loadWithPlayerParams");
  ...
  [self addSubview:self.webView];
   ...
   NSString *gluonPath = [documentsDir stringByAppendingPathComponent:@"gluon"];
   NSString *assetsPath = [gluonPath stringByAppendingPathComponent:@"assets"];

  NSError *error = nil;
  NSString *path = [assetsPath stringByAppendingPathComponent:@"YTPlayerView-iframe-player.html"];;
